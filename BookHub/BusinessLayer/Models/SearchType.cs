...
public class SearchType
{
    ...
    public SearchType(IEnumerable<AuthorDetail> authors, IEnumerable<BookDetail> books, IEnumerable<GenreDetail> genres, IEnumerable<PublisherDetail> publishers, IEnumerable<RatingDetail> ratings)
    {
        Authors = authors;
        Books = books;
        Genres = genres;
