...
public static class DataSeeder
{
    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        //     new { BooksId = 1, OrdersId = 1, Count = 2 },
        //     new { BooksId = 2, OrdersId = 2, Count = 2 },
        //     new { BooksId = 3, OrdersId = 3, Count = 2 },
        //     new { BooksId = 3, OrdersId = 8, Count = 2 },
        //     new { BooksId = 3, OrdersId = 13, Count = 2 },
        //     new { BooksId = 4, OrdersId = 3, Count = 2 },
        //     new { BooksId = 5, OrdersId = 4, Count = 2 },
        //     new { BooksId = 5, OrdersId = 30, Count = 2 },
        //     new { BooksId = 6, OrdersId = 5, Count = 2 },
        //     new { BooksId = 7, OrdersId = 6, Count = 2 },
        //     new { BooksId = 7, OrdersId = 29, Count = 2 },
        //     new { BooksId = 8, OrdersId = 7, Count = 2 },
        //     new { BooksId = 9, OrdersId = 28, Count = 2 },
        //     new { BooksId = 10, OrdersId = 27, Count = 2 },
        //     new { BooksId = 12, OrdersId = 9, Count = 2 },
        //     new { BooksId = 11, OrdersId = 10, Count = 1 },
        //     new { BooksId = 12, OrdersId = 11, Count = 1 },
        //     new { BooksId = 13, OrdersId = 26, Count = 1 },
        //     new { BooksId = 14, OrdersId = 25, Count = 1 },
        //     new { BooksId = 15, OrdersId = 12, Count = 1 },
        //     new { BooksId = 16, OrdersId = 24, Count = 1 },
        //     new { BooksId = 17, OrdersId = 23, Count = 1 },
        //     new { BooksId = 18, OrdersId = 14, Count = 1 },
        //     new { BooksId = 19, OrdersId = 15, Count = 1 },
        //     new { BooksId = 19, OrdersId = 12, Count = 1 },
        //     new { BooksId = 19, OrdersId = 22, Count = 1 },
        //     new { BooksId = 20, OrdersId = 21, Count = 1 },
        //     new { BooksId = 20, OrdersId = 20, Count = 1 },
        //     new { BooksId = 21, OrdersId = 9, Count = 3 },
        //     new { BooksId = 22, OrdersId = 10, Count = 1 },
        //     new { BooksId = 23, OrdersId = 11, Count = 9 },
        //     new { BooksId = 23, OrdersId = 3, Count = 1 },
        //     new { BooksId = 24, OrdersId = 2, Count = 1 },
        //     new { BooksId = 25, OrdersId = 1, Count = 1 },
        //     new { BooksId = 26, OrdersId = 5, Count = 1 },
        //     new { BooksId = 27, OrdersId = 6, Count = 1 },
        //     new { BooksId = 28, OrdersId = 7, Count = 1 },
        //     new { BooksId = 29, OrdersId = 13, Count = 2 },
        //     new { BooksId = 30, OrdersId = 15, Count = 2 },
        //     new { BooksId = 31, OrdersId = 7, Count = 2 },
        //     new { BooksId = 32, OrdersId = 16, Count = 1 },
        //     new { BooksId = 33, OrdersId = 16, Count = 1 },
        //     new { BooksId = 33, OrdersId = 17, Count = 1 },
        //     new { BooksId = 34, OrdersId = 18, Count = 1 },
        //     new { BooksId = 35, OrdersId = 3, Count = 1 },
        //     new { BooksId = 35, OrdersId = 8, Count = 1 },
        //     new { BooksId = 35, OrdersId = 19, Count = 2 });
